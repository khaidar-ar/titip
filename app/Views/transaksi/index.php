...
<body>
    ...
    <nav class="sidebar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="home"><i class="fas fa-money-bill-wave"></i> PINJAMAN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="anggota"><i class="fas fa-calendar-alt"></i> ANGSURAN</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <p>Menyimpan data transaksi yang dicatat oleh petugas.</p>
