                    ...
                    <?php if(!empty($petugas)): ?>
                        <?php foreach($petugas as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="petugas/edit/<?= $row['id_petugas']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="petugas/delete/<?= $row['id_petugas']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
