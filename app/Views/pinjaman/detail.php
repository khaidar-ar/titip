...
<body>
    ...
    <nav class="sidebar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a id="pinjamanLink" class="nav-link" ref="pinjaman"><i class="fas fa-money-bill-wave"></i> PINJAMAN</a>
                </li>
                <li class="nav-item">
    ...
    <?php if (!empty($pinjaman)): ?>
        <p>Nama Petugas: <?= isset($petugas) ? esc($petugas) : 'Petugas tidak tersedia' ?></p>
        <p>Nama Anggota: <?= isset($anggota) ? esc($anggota) : 'Anggota tidak tersedia' ?></p>
        <p>Tanggal Pinjaman: <?php echo $pinjaman['tanggal_pinjaman']; ?></p>
        <p>Tenor: <?php echo $pinjaman['tenor']; ?></p>
        <p>Jumlah Pinjaman: <?php echo $pinjaman['jumlah_pinjaman']; ?></p>
        <p>Total Pembayaran: <?php echo $pinjaman['total_pembayaran']; ?></p>
        <p>Bunga: <?php echo $pinjaman['bunga']; ?></p>
        <p>Status: <?php echo $pinjaman['status']; ?></p>
    <?php else: ?>
        <p>No pinjaman found.</p>
    <?php endif; ?>
    </div>
    <!-- Bootstrap JS -->
