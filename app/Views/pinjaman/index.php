                    ...
                    <?php if (!empty($pinjaman)) : ?>
                        <?php foreach ($pinjaman as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="pinjaman/edit/<?= $row['id_pinjaman']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></i></a>
                                    <a href="pinjaman/delete/<?= $row['id_pinjaman']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash"></i></a>
                                    <a href="pinjaman/detail/<?= $row['id_pinjaman']; ?>" class="btn btn-info btn-sm"><i class="fa-solid fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
