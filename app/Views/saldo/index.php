...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            <h2>Data Saldo</h2>
            <p>Menyimpan saldo total simpanan wajib dan pokok per anggota.</p>
            <a href="saldo/create" class="btn btn-success mb-3">Tambah Saldo</a>
                    ...
                    <?php if(!empty($saldo)): ?>
                        <?php foreach($saldo as $row): ?>
                            <tr>
                                ...
                                <td><?= $row['saldo_wajib']; ?></td>
                                <td><?= $row['saldo_pokok']; ?></td>
                                <td>
                                    <a href="saldo/edit/<?= $row['id_saldo']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="saldo/delete/<?= $row['id_saldo']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
