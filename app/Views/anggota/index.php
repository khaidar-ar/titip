                    ...
                    <?php if(!empty($anggota)): ?>
                        <?php foreach($anggota as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="anggota/edit/<?= $row['id_anggota']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="anggota/delete/<?= $row['id_anggota']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
