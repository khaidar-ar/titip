                    ...
                    <?php if (!empty($angsuran)) : ?>
                        <?php foreach ($angsuran as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="angsuran/edit/<?= $row['id_angsuran']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></i></a>
                                    <a href="angsuran/delete/<?= $row['id_angsuran']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
